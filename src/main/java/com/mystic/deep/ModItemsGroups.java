    ...
    public static final ItemGroup MYSTICDEEP_GROUP = Registry.register(Registries.ITEM_GROUP,
        new Identifier(MysticDeep.MOD_ID, "icon"), FabricItemGroup.builder().displayName(Text.translatable("itemgroup.MysticDeep"))
            .icon(() -> new ItemStack(ModItems.MARINITE_INGOT)).entries((displayContext, entries) -> {             
                ...
                entries.add(ModItems.ABYSSITE_HELMET);
                entries.add(ModItems.ABYSSITE_CHESTPLATE);
                entries.add(ModItems.ABYSSITE_LEGGINGS);
                entries.add(ModItems.ABYSSITE_BOOTS);
                ...
                entries.add(ModItems.EARTHCORE_HELMET);
                entries.add(ModItems.EARTHCORE_CHESTPLATE);
                entries.add(ModItems.EARTHCORE_LEGGINGS);
                entries.add(ModItems.EARTHCORE_BOOTS);
                ...
                entries.add(ModItems.FLAMESTONE_HELMET);
                entries.add(ModItems.FLAMESTONE_CHESTPLATE);
                entries.add(ModItems.FLAMESTONE_LEGGINGS);
                entries.add(ModItems.FLAMESTONE_BOOTS);
                ...
                entries.add(ModItems.LEVRAISTEELTV_PLUSH);
                entries.add(ModItems.M26G_PLUSH);
